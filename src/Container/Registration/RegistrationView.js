  ...
  return (
    <div className="__container">
      ...
      <div
        ...
        className="registration__details__container"
      >
        ...
        /> */}
            ...
            <div className="form__group">
              <input
                ...
                onChange={(e) => props.handelData("first_name", e.target.value)}
              />
            </div>
            <div className="form__group">
              <input
                ...
                onChange={(e) => props.handelData("last_name", e.target.value)}
              />
            </div>
            <div className="form__group">
              <input
            ...
            <div className="form__group">
              <input
                type="text"
                value={props.mobile}
                onChange={(e) => props.handelData("mobile", e.target.value)}
                className="form__control"
                id="uname"
            ...
            <div className="form__group">
              <input
                ...
                onChange={(e) => props.handelData("password", e.target.value)}
                className="form__control"
                id="pwd"
        ...
        <div className="registration__view__footer">
          ...
          <a onClick={() => history.replace("/login")}> Login</a>
        </div>
      </div>
    </div>
  );
