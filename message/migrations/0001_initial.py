    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_message_datetime', models.DateTimeField(blank=True, default=datetime.datetime(2021, 1, 16, 4, 41, 0, 763627), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(blank=True, default=datetime.datetime(2021, 1, 16, 4, 41, 0, 765346), null=True)),
